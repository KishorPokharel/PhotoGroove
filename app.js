			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$src($author$project$PhotoGallery$urlPrefix + ('large/' + selectedUrl))
					]),
				_List_Nil)
			]);
	});
...
var $author$project$Main$viewFooter = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$text('One is never alone with a rubber duck. - Doublas Adams')
		]));
